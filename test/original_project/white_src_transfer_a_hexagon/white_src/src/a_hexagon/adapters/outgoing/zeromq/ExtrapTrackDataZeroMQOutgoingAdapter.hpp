...
namespace adapters {
namespace outgoing {
class ExtrapTrackDataZeroMQOutgoingAdapter : public domain::ports::outgoing::ExtrapTrackDataOutgoingPort{
public: 
    ExtrapTrackDataZeroMQOutgoingAdapter(); // Parametresiz constructor
