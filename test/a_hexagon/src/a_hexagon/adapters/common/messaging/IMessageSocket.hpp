 ...
 * @brief Abstract messaging socket interface for DIP compliance
 ...
 * @see MockMessageSocket.hpp
 */

#ifndef A_HEXAGON_ADAPTERS_COMMON_MESSAGING_IMESSAGE_SOCKET_HPP
#define A_HEXAGON_ADAPTERS_COMMON_MESSAGING_IMESSAGE_SOCKET_HPP
 ...
 * @code
 * // Production code:
 * auto socket = std::make_unique<ZeroMQSocket>(ZMQ_SUB);
...
public:
     ...
     * @return Socket type string (e.g., "ZeroMQ_SUB", "ZeroMQ_PUB", "Mock")
     * @thread_safe Yes
     */
...
#endif // A_HEXAGON_ADAPTERS_COMMON_MESSAGING_IMESSAGE_SOCKET_HPP
