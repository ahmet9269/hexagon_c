/**
 * @file TargetStatisticServiceTest.cpp
 * @brief Unit tests for TargetStatisticService domain logic
 */
...
/**
 * @brief Test fixture for TargetStatisticService tests
 */
class TargetStatisticServiceTest : public ::testing::Test {
protected:
...
TEST_F(TargetStatisticServiceTest, DefaultConstructor_CreatesServiceWithoutPort) {
    TargetStatisticService service;
    // Should not throw
    SUCCEED();
}

TEST_F(TargetStatisticServiceTest, ConstructorWithPort_AcceptsOutgoingPort) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    // Explicit conversion to interface type to avoid ambiguity
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
    // Should not throw
    SUCCEED();
}
...
TEST_F(TargetStatisticServiceTest, SubmitDelayCalcTrackData_ProcessesData) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
...
TEST_F(TargetStatisticServiceTest, SubmitDelayCalcTrackData_PreservesTrackId) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, SubmitDelayCalcTrackData_CopiesPositions) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, SubmitDelayCalcTrackData_CopiesVelocities) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessData_CopiesFirstHopDelayTime) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessData_CalculatesSecondHopDelay) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessData_SetsThirdHopSentTime) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessData_CalculatesTotalDelay) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessData_WithNullPort_DoesNotCrash) {
    TargetStatisticService service;  // No outgoing port
...
TEST_F(TargetStatisticServiceTest, ProcessData_WithNotReadyPort_DoesNotSend) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
...
TEST_F(TargetStatisticServiceTest, ProcessMultipleData_AllAreSent) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessData_WithZeroDelays_Works) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
...
TEST_F(TargetStatisticServiceTest, ProcessDelayCalcData_WorksSameAsSubmit) {
    auto mockPort = std::make_unique<MockOutgoingPort>();
    MockOutgoingPort* mockPortPtr = mockPort.get();
    TargetStatisticService service(std::unique_ptr<outgoing::ITrackDataStatisticOutgoingPort>(std::move(mockPort)));
