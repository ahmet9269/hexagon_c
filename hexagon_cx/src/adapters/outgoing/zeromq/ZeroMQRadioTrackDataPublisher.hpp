...
/**
 * Radio-Dish pattern kullanan ZeroMQ Publisher Adapter
 * UDP multicast üzerinden grup tabanlı mesajlaşma sağlar
 * app2_processor.cpp'deki radio-dish pattern'ini hexagonal architecture'a entegre eder
 */
